cancelBySpecDetailButton = document.getElementById("cancelBySpecDetailButton");

function doCancelBySpecDetail() {
...
cancelBySpecDetailButton.addEventListener("click", doCancelBySpecDetail);